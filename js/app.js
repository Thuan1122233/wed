...
export const showlistbanchay = () => {
    const html_arr = banchay_arr.map(hienspbanchay);
    return html_arr.join("");
};
const hienspnoibat = (noibat) => {
    return `<div>
    <img src="${noibat.hinh}">
...
export const showlistnoibat = () => {
    const html_arr = noibat_arr.map(hienspnoibat);
    return html_arr.join("");
};
const hienspgiamgia = (giamgia) => {
    return `<div>
...
export const showlistgiamgia = () => {
    const html_arr = giamgia_arr.map(hienspgiamgia);
    return html_arr.join("");
};
